 ...
 * -all’avvio si mette in ascolto sulla porta 8081 e carica da un suo file locale in formato JSON, un dizionario le cui chiavi sono numeri di matricola e i valori sono studenti.
 * Il file JSON è del tipo mostrato qui di seguito: {"123456":"Mario Rossi","123457":"Lara Bianchi","123458":"Giuseppe Verdi"}
 * -risponde a richieste di servizio di tipo GET con URL della forma: http://localhost:8081/server?mat=xxxxxx 
 *  (dove xxxxxx è un numero di matricola), inviando in risposta al client il nome corrispondente alla matricola specificata come parametro. 
 * -Se ad esempio la richiesta fosse: http://localhost:8081/server?mat=123456 il server invierebbe in risposta la stringa "Mario Rossi".
