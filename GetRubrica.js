 ...
 *  {"Rossi#Mario":"3454623488","Bianchi#Franca":"3339416545","Rossi#Giada":"3239916542"} dove ogni coppia Cognome#Nome è una stringa senza spazi.
 * -risponde a richieste di servizio di tipo GET con URL della forma:http://localhost:8080/server?cognome=xxx (dove xxx è il cognome di una utenza),
 * inviando in risposta al client la lista delle utenze (con relativo  numero di telefono) che hanno il cognome specificato. 
 * Se ad esempio la richiesta fosse: http://localhost:8081/server?cognome=Rossi il server invierebbe in risposta la lista:
 * "[Rossi Mario – 3454623488, Rossi Giada –239916542]".
